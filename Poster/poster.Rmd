...
![](poster_files/figure-html/parset_4peeps_reducedsize.PNG)
...
As for Axel Calzas, we realize that this person does not have non-work correspondence, and any work related emails are department of company based. This eliminates the suspicious off and we removed the name.
...
The range of techniques and ideas executed in this project is non-exhaustive and We suggest that the below can be explored in the future development of the app:
