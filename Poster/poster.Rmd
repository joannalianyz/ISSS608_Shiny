...
Looking at the unfiltered credit card transactions data, we see that there are a few outliers. Looking at statistical analysis confirms that the outliers are worth investigating.
