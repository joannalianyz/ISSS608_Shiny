...
* Additional user interaction features within each tab in the app. E.g. users could be given the option to highlight certain transactions in the histogram or the violin plot which can speed up the detection of suspicious individuals.
